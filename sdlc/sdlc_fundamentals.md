...
*   **BA (Business Analyst - Nhà phân tích nghiệp vụ):**
    ...
    *   *Lưu ý cốt lõi:* Trong mô hình Scrum chuẩn, **BA không thuộc về duy nhất một Scrum team cố định**. BA có thể hoạt động độc lập hoặc hỗ trợ nhiều team khác nhau tùy theo luồng nghiệp vụ cần phân tích.
